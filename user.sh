...
cp -rp /home/centos/roboshell_terraform/user.service /etc/systemd/system/user.service &>> $LOGFILE
...
cp -rp /home/centos/roboshell_terraform/mongo.repo /etc/yum.repos.d/mongo.repo &>> $
