...
D=$(date +%F:%H:%M:%S)
SCRIPT_NAME=$0
LOG_PATH=/home/centos/roboshell_terraform/logs
...
cp -rp /home/centos/roboshell_terraform/catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
cp -rp /home/centos/roboshell_terraform/mongo.repo /etc/yum.repos.d/mongo.repo &>>$LOGFILE
